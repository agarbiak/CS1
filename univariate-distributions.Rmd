...
The binomial probability distribution ($Y$) can be defined by the number of successes in a sequence of $n$ independent, identically distributed ("_i.i.d._") Bernoulli trials. A Bernoulli trial is a random experiment with exactly two outcomes, \{"_success_", "_failure_"\}, wherein the probability of success is $p$. We often state the probability of failure as $q = 1 - p$ for convenience. More formally, if we have $k \in \{0,\,1,\,2,\, \dots,\, n \}$ successes given $n$ independent trials with the $P($"_success_"$)$ on each trial defined as $p$, then:
